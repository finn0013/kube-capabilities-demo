...
echo Lists most recent logs for a given pod. Often enough for basic debugging. Use -f to update in real time.
...
echo -e "nsenter --target :PROC_ID --mount --uts --ipc --net --pid \t# Voila. Note these are dash-dash.\033[0m"
